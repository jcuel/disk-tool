...
- Delta spec at `openspec/changes/<change-name>/specs/app/spec.md`
- Source spec at `openspec/specs/app/spec.md`

## Steps

1. Read the delta spec ADDED/MODIFIED/REMOVED blocks.
2. Merge changes into `openspec/specs/app/spec.md` (apply additions, update modifications, remove deletions).
...
- Updated `openspec/specs/app/spec.md`
