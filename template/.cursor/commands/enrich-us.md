...
5. **GitHub:** create or link an issue titled `[<change-name>] …`; set project Status **Backlog**; assign milestone (v0.2 / v1.0 / Future); post initial comment with link to `user-story.md`.
